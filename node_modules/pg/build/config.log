# project noname (0.0.1) configured on Sun Mar 17 00:34:57 2013 by
# waf 1.5.16 (abi 7, python 20701f0 on darwin)
# using /usr/local/Cellar/node/0.8.16/bin/node-waf configure build
#
...
ok /usr/local/Cellar/node/0.8.16
